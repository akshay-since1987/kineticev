...
startLayout("The Legend Is Reborn | Kinetic Electric Scooter", [
    ...
    'additionalScripts' => '<script id="pixel-script-poptin" src="https://cdn.popt.in/pixel.js?id=190e166821bdb" async="true"></script>'
]);
    ...
    <div class="emi-container">
        <div class="emi-content">
            <div class="emi-header">
                <h2>Own Your Kinetic EV with Flexible EMIs</h2>
            </div>
            <div class="emi-description">
                <p>Ride smarter with Flexible EMI Options—use our EMI Calculator to plan your monthly instalments and choose the right Kinetic EV scooter that best fits your lifestyle and budget.</p>
            </div>
            <div class="emi-actions">
                <a href="#" id="calculate-emi-btn" class="emi-btn primary">Calculate EMI</a>
            </div>
        </div>
        <div class="emi-visual">
            <div class="emi-calculator-preview">
                <div class="calculator-mockup">
                    <div class="calc-header">EMI Calculator</div>
                    <div class="calc-inputs">
                        <div class="calc-row">
                            <label>Loan Amount</label>
                            <input type="number" id="loan-amount" value="111499" min="50000" max="200000" step="1000">
                        </div>
                        <div class="calc-row">
                            <label>Interest Rate (%)</label>
                            <input type="number" id="interest-rate" value="12" min="8" max="20" step="0.5">
                        </div>
                        <div class="calc-row">
