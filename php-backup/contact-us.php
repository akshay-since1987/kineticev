                            ...
                            if (!$contact_id) {
                                ...
                                try {
                                    ...
                                    if (!empty($emailIssues)) {
                                        ...
                                        $success_message = "Thank you for contacting us! We have received your message and our team will get back to you within {$responseTime}.";
                                    } else {
                                        $responseTime = isset($emailConfig['response_time']) ? $emailConfig['response_time'] : '24 hours';
                                        $success_message = "Thank you for contacting us! We have received your message and our team will get back to you within {$responseTime}.";
                                    }
                                    ...
                                    $success_message = "Thank you for contacting us! We have received your message and our team will get back to you within 24 hours. Note: There was an issue with email notifications, but your message has been saved successfully.";
