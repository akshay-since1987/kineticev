        ...
        <div class="faq-text container">
            <div class="faq-group">
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <strong>Easy Key:</strong> Easy access to your Kinetic with passcode access. It's truly keyless.
                        You can update your passcode from your phone, no need to find or keep keys. (Bluetooth keyfob
                        available as an accessory).<br><br>
                        <strong>Easy Charge: </strong>It eliminates the hassle of carrying an off-board charger that
                        ...
                        DX+.<br><br>
                        <strong>Easy Flip: </strong>You can access the pillion footrest without bending. Just Flip’em at
                        the press of a button on the Handlebar.
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        The battery is covered under the following warranty options:<br><br>
                        <ul>
                            <li>
            ...
            <div class="faq-group">
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        To check the status of your DX or DX+ order, simply share your booking number via email at <strong>info@kineticev.in</strong> or contact our customer care team on <strong>86000 96800</strong>, and our team will provide you with the latest update on your order.
                    </div>
                </details>
