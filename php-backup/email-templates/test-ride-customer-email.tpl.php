...
<body>
    <div class='container'>
        <div class='header'>
            <h2>Test Ride Request Confirmed!</h2>
        </div>
        <div class='content'>
            ...
            <h3>Your Kinetic EV Test Ride is Confirmed!</h3>
            ...
            <div class='highlight'>
                <strong>Your Test Ride is Confirmed!</strong><br>
            ...
            <p>Our dedicated test ride specialists will contact you within <?php echo htmlspecialchars($emailConfig['response_time'] ?? '24 hours'); ?> to:</p>
            ...
            <p><?php echo htmlspecialchars($emailConfig['showroom_contact'] ?? ''); ?></p>
            ...
            <p>Can't wait to speak with us? Feel free to call our test ride hotline at <a href="tel:<?php echo htmlspecialchars($emailConfig['support_phone'] ?? '+918600096800'); ?>" style="color: #ef0012; text-decoration: none; font-weight: bold;"><?php echo htmlspecialchars($emailConfig['support_phone'] ?? '+91 860 009 6800'); ?></a> - we're here to help!</p>
